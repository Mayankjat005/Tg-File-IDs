...
api_id = '23159366'
api_hash = '4623dd30dd1303bddb729eb0862262d9'
bot_token = '6594752292:AAGt-EqI_HmVHe6xNoAGVFQSqqFMwTinFCQ'
...
async def start_command(bot, message: Message):
    ...
    await message.reply_text(
        ...
        [
          [
          InlineKeyboardButton('📍 𝐔𝐩𝐝𝐚𝐭𝐞 𝐂𝐡𝐚𝐧𝐧𝐞𝐥', url='https://t.me/WarriorUnitsBots'),
      ],
      [
          InlineKeyboardButton('👩‍💻 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫', url='https://t.me/OO7Jatji'),
          InlineKeyboardButton('🚨 𝐒𝐮𝐩𝐩𝐨𝐫𝐭 𝐆𝐫𝐨𝐮𝐩', url='https://t.me/Warrior_Units'),
          ],
          [
